(() => {
  ...
  function renderHome(data) {
    ...
    const definitions = [['All','All'],['Current additions','Current additions'],['Release 16 additions','Release 16 additions'],['Launch shortlist','Launch shortlist'],['Recommended first product','Recommended first product'],['Software-Validated','Software-Validated'],['Verified Prototype','Verified Prototype'],['Research','Research']];
    ...
    const matches = (asset) => active === 'All' || (active === 'Current additions' && RELEASE_17_ADDITIONS.has(asset.slug)) || (active === 'Release 16 additions' && RELEASE_16_ADDITIONS.has(asset.slug)) || (active === 'Launch shortlist' && asset.launch) || (active === 'Recommended first product' && asset.launch?.rank === 1) || asset.status === active;
    function draw() {
