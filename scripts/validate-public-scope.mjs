...
assert(profilePaths.length===81,'81 profiles');
...
console.log('Public-scope checks passed: curated public payloads, 81 public project profiles, no restricted file types or credential patterns. This automated gate supplements editorial review; it is not a legal or security certification.');
